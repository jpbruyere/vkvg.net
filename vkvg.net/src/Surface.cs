...
namespace vkvg
{
	public class Surface: ISurface
	{
		...
		public static Surface CreateFromSvg (Device dev, uint width, uint height, string svgFilePath) {
			return new Surface (dev, NativeMethods.vkvg_surface_create_from_svg (dev.Handle, width, height, svgFilePath));
		}
